...
<html lang="en">
  ...
  <head>
    ...
    <meta name="title" content="AdminLTE 4 | Data Agama" />
  ...
  <body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
          ...
          <div class="container-fluid">
            ...
            <div class="row">
              ...
              <style>
                  ...
                  /* Styling untuk button tambah data */
                  .button-container {
                      display: flex;
              ...
              <div class="table-container">
                  <!-- Container untuk button tambah data -->
                  <div class="button-container">
                      <?php if (isset($_SESSION['role']) && $_SESSION['role'] == 'admin'): ?>
                          <a href="tambahagama.php" class="btn-add">
                  ...
                  <table id="tabelAgama">
                      ...
                      <tbody>
                          ...
                          <tr>
                              ...
                              <td>
                                  <?php if (isset($_SESSION['role']) && $_SESSION['role'] == 'admin'): ?>
                                      <a href="editagama.php?idAgama=<?php echo urlencode($row['idAgama']); ?>" class="btn btn-edit">
                                          <i class="bi bi-pencil-square"></i> Edit
                                      </a>
                                      <button onclick="confirmHapus('<?php echo $row['idAgama']; ?>')" class="btn btn-delete">
    ...
    <script>
        ...
        function confirmHapus(idAgama) {
            Swal.fire({
                title: 'Yakin ingin menghapus?',
                text: "Data agama ini akan hilang selamanya!",
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    ...
                    fetch(`hapus_agama.php?idAgama=${idAgama}`)
                        .then(response => {
                            if (!response.ok) {

...
<html lang="en">
  ...
  <head>
    ...
    <!-- Custom CSS untuk Watermark Logo -->
    <style>
    /* CSS untuk watermark logo di kanan bawah */
    .watermark-logo {
        position: fixed;
        bottom: 20px;
        right: 20px;
        z-index: 1;
        opacity: 0.15; /* Opacity rendah untuk efek samar */
    ...
    .watermark-logo img {
        ...
        height: auto;
        filter: blur(0.5px); /* Efek blur ringan */
    ...
    /* Custom CSS untuk mengubah posisi dan style icon di small-box */
.small-box .icon {
    position: absolute;
    top: auto !important;
    bottom: 60px !important; /* Posisi dari bawah */
    right: 30px !important; /* Pindah ke kanan */
    left: auto !important; /* Hilangkan posisi kiri default */
    transition: all 0.3s linear;
    opacity: 0.5 !important; /* Opacity setengah */
    z-index: 0;
}

.small-box .icon > i {
    font-size: 65px !important; /* Ukuran icon lebih besar */
    color: rgba(255, 255, 225, 0.7) !important; /* Warna putih transparan */
}

/* Pastikan konten inner tidak tertutup icon */
.small-box .inner {
    position: relative;
    z-index: 1;
    padding: 20px 15px;
...
@media (max-width: 768px) {
    .small-box .icon > i {
        font-size: 45px !important; /* Ukuran lebih kecil di mobile */
    }
